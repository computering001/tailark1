...
type ResponsiveContainerProps = React.ComponentProps<(typeof import('recharts'))['ResponsiveContainer']>
type ChartTooltipProps = React.ComponentProps<(typeof import('recharts'))['Tooltip']>
type ChartLegendProps = React.ComponentPropsWithoutRef<(typeof import('recharts'))['Legend']>
type ChartLegendContentProps = import('recharts').LegendProps

const ResponsiveContainer = dynamic<ResponsiveContainerProps>(() => import('recharts').then((module) => module.ResponsiveContainer))
const ChartTooltip = dynamic<ChartTooltipProps>(() =>
    import('recharts').then(({ Tooltip }) => {
        function LoadedTooltip(props: ChartTooltipProps) {
...
const ChartLegend = dynamic<ChartLegendProps>(() =>
    import('recharts').then(({ Legend }) => {
        function LoadedLegend(props: ChartLegendProps) {
            return <Legend {...props} />
        }
...
function ChartTooltipLabel({
    ...
    labelClassName,
    labelKey,
}: Pick<ChartTooltipProps, 'payload' | 'label' | 'labelFormatter'> & {
    config: ChartConfig
