...
export const Table = ({ className }: { className?: string }) => {
    return (
        <div className={cn('bg-illustration/90 ring-border-illustration shadow-black/6.5 from-card/50 md:min-w-3xl relative mx-auto w-full max-w-4xl rounded-2xl border border-transparent p-6 pb-12 shadow-md ring-1', className)}>
