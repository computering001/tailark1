        ...
        <section className="bg-background py-24">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="mx-auto mt-20 max-w-2xl text-center">
                    ...
                    <h1 className="mt-4 text-balance text-4xl font-semibold md:text-5xl lg:text-6xl tracking-tight">Connect all your preferred applications</h1>
                    ...
                    <Button
                        render={<Link href="#link">Browse Integrations</Link>}
                        nativeButton={false}
                    />
                </div>
            </div>
