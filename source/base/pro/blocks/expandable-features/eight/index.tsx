...
export default function ExpandableFeatures() {
    ...
    return (
        ...
        <section className="bg-background @container overflow-hidden py-24">
            <div
                aria-hidden
                className="border-foreground/10 h-px border-b border-dashed"
            />
            ...
            <div className="mx-auto my-1 max-w-5xl px-2 sm:px-6">
                <div className="grid md:grid-cols-2 md:gap-6">
                    <div className="relative p-6 sm:p-12">
                        <div
                            aria-hidden
                            className="mask-y-from-80% border-foreground/10 pointer-events-none absolute -inset-x-1 -bottom-56 -top-36 border-x border-dashed"
                        />
            ...
            />
            <div className="@2xl:py-12 mx-auto max-w-5xl px-2 py-6 sm:px-6">
                <div className="@2xl:grid-cols-2 @2xl:px-12 @2xl:gap-6 grid gap-12 px-6">
