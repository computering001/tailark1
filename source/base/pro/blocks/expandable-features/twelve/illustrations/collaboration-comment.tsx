        ...
        <div>
            ...
            <div className="min-w-sm group absolute inset-0 m-auto flex size-fit justify-end gap-2">
                ...
                <div
                    ...
                    className="bg-illustration group-peer-active:scale-99 not-data-[shown=true]:scale-99 not-data-[shown=true]:opacity-0 max-w-2xs shadow-black/6.5 ring-border-illustration relative origin-top-left rounded-2xl shadow-lg ring-1 transition-[opacity,transform] duration-200">
                    <button
                        type="button"
