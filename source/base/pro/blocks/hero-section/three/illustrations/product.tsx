...
import { InteractiveLineChart } from '@/components/illustrations/interactive-line-chart'
                            ...
                            <div className="shadow-black/6.5 ring-border-illustration bg-illustration relative z-10 rounded-xl p-6 shadow-md ring-1">
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <button type="button" className="text-primary mt-3 text-xs font-medium">View Details</button>
                                    </div>
                                </div>
                            </div>
                        </div>
