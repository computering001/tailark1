    ...
    >
      <div
        className={cn(
          ...
          "has-data-open:border-transparent lg:has-data-open:h-[calc(var(--nav-viewport-height,0px)+3.4rem)] lg:has-data-open:border-b lg:has-data-open:bg-card/75 lg:has-data-open:shadow-lg lg:has-data-open:shadow-black/6.5 lg:has-data-open:ring-border lg:has-data-open:backdrop-blur",
        ...
        {mobileLinks.map((link) => {
          if (link.groupName && link.links) {
            return (
              ...
              >
                <AccordionTrigger className="flex items-center justify-between border-b-0 py-3 text-lg **:font-normal! data-open:bg-foreground/5">
                  {link.groupName}
                </AccordionTrigger>
