...
const NavMenu = () => {
  return (
    <NavigationMenu
      viewport={false}
      // Base paints the card on Popup (docs); Content rounded/shadow won't reach it.
      className="**:data-[slot=navigation-menu-viewport]:rounded-3xl **:data-[slot=navigation-menu-viewport]:shadow-black/5"
    >
