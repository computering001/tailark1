...
const members: Member[] = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1364&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=1364&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=1364&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=1364&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  return (
    <section className="bg-background py-16 md:py-32">
      <div className="@container mx-auto max-w-5xl px-6">
        <div>
          <h2 className="max-w-xs text-4xl font-semibold text-balance text-foreground tracking-tight">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {members.map((member, index) => (
              <div
                key={member.name}
                className="rounded-3xl bg-card p-2 shadow-xl ring-1 shadow-black/3 ring-border"
              >
