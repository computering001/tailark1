...
const members: Member[] = [
    ...
    },
    {
        ...
        decoratorColors: 'from-purple-400 via-fuchsia-400 to-emerald-500',
    },
    {
        name: 'Rachel Kim',
            ...
            <div className="@container mx-auto max-w-5xl px-6">
                <div className="grid gap-16 lg:grid-cols-5 lg:gap-24">
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-muted-foreground mt-4 text-lg">Our team thrives on collaboration, creativity, and a shared commitment to excellence. </p>
                    </div>

                    <div className="grid grid-cols-2 gap-16 sm:grid-cols-3 md:max-lg:grid-cols-4 lg:col-span-3">
                        {members.map((member) => (
                            <div key={member.name}>
