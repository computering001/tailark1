...
export default function CodeBlock() {
  ...
  return (
    ...
    <div className="relative z-10 overflow-hidden rounded-2xl border border-transparent bg-illustration from-zinc-50 pt-6 shadow-lg ring-1 shadow-black/6.5 ring-border-illustration">
      <div className="relative z-10 px-3">
        <div className="flex gap-1.5 px-3">
          <div className="size-2 rounded-full border border-black/5 bg-muted-foreground/10"></div>
          <div className="size-2 rounded-full border border-black/5 bg-muted-foreground/10"></div>
          <div className="size-2 rounded-full border border-black/5 bg-muted-foreground/10"></div>
        </div>
      ...
      <div className="h-82">
        <CodeBlockView
          ...
          theme="github-light"
          lineNumbers
          className="-mx-1 [&_pre]:h-80 [&_pre]:min-h-[12rem] [&_pre]:border-none [&_pre]:bg-transparent! [&_pre]:mask-y-from-85%"
        />
      </div>
    </div>
