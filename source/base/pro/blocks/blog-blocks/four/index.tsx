                    ...
                    <div
                        ...
                        {filters.map((category) => (
                            <button type="button"
                                ...
                                <span className={cn('flex w-fit items-center gap-2 rounded-md px-3 py-1 text-sm transition-colors [&>svg]:size-4', activeFilter === category ? 'bg-card ring-border shadow-black/6.5 text-primary font-medium shadow-sm ring-1' : 'hover:text-foreground group-hover:bg-foreground/5')}>
                        ...
                        <div className="relative space-y-8">
                            ...
                            <div className="grid gap-6 sm:grid-cols-2 sm:gap-x-8 sm:gap-y-12 lg:grid-cols-3">
                                {moreArticles.map((article, index) => (
                                    <article
                                        key={article.title}
                                        className="group relative space-y-4 transition-none duration-200">
                                        <div className="bg-card/75 ring-border-illustration hover:bg-card/50 rounded-xl border border-transparent p-0.5 shadow-md ring-1">
                                            <div className="before:border-border-illustration relative aspect-video overflow-hidden rounded-[10px] before:absolute before:inset-0 before:rounded-[10px] before:border">
                                                <Image
                                                    src={article.image}
