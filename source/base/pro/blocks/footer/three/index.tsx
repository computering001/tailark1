...
export default function FooterSection() {
  return (
    <>
      <section className="from-backgroundt relative bg-linear-to-b from-50% to-muted to-50% pt-12 md:pt-24 dark:to-card">
        <div className="mx-auto max-w-5xl px-6">
          <Card className="relative overflow-hidden p-12 shadow-lg md:px-32 md:py-20">
            ...
            <div className="relative text-center">
              <h2 className="text-3xl font-semibold text-balance md:text-4xl tracking-tight">
      ...
      <footer className="bg-muted py-12 sm:py-20 dark:bg-card">
