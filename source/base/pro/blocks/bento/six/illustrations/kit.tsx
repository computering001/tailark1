...
export const Kit = () => {
  return (
    <div
      aria-hidden
      className="h-fit mask-b-from-55% px-6 perspective-dramatic"
    >
      <div className="relative mx-auto mt-auto h-fit translate-x-4 -skew-x-4">
        <div className="absolute -bottom-6 left-0 z-10 h-64 w-3/4 overflow-hidden rounded-2xl border border-transparent bg-illustration/75 shadow-2xl ring-1 shadow-black/10 ring-border-illustration backdrop-blur">
