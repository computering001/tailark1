export const DocumentPdfIllustration = () => {
  return (
    <div aria-hidden className="relative size-fit">
      <div className="absolute -right-3 bottom-2 z-2 rounded bg-rose-500 px-1.5 py-0.5 text-[10px] font-semibold text-white shadow-lg shadow-rose-900/25 text-shadow-sm after:absolute after:inset-0 after:rounded after:border after:border-foreground/15">
        PDF
      </div>
