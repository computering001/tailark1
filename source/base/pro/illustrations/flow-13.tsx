  ...
  return (
    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        <m.div
          className="ring-border-illustration h-8 overflow-hidden rounded-full bg-card px-4 ring-1"
          layout="size"
        ...
        <div className="relative mt-14 mb-13.5 flex size-17 -translate-y-px">
          ...
          <div className="ring-border-illustration relative m-auto flex size-11 items-center justify-center rounded-full bg-radial from-card from-35% to-card/50 shadow-xl ring-1 shadow-black/6.5 backdrop-blur">
            <LogoIcon
        ...
        <div className="relative">
          ...
          <div className="bg-illustration ring-border-illustration h-26 w-56 overflow-hidden rounded-2xl px-5 py-3 text-sm text-foreground/65 shadow-md ring-1 shadow-black/6.5">
