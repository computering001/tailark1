...
export const AddCommentIllustration = ({
  className,
}: {
  className?: string
}) => {
  return (
    <div aria-hidden className={cn("relative mt-8", className)}>
      <div
        className={cn(
          "bg-illustration absolute flex h-10 -translate-x-1/8 translate-y-[-110%] items-center gap-3 rounded-lg py-1 pr-12 pl-2",
          "ring-border-illustration border border-transparent shadow-lg ring-1 shadow-black/6.5"
        )}
      >
