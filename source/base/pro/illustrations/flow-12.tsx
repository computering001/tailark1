...
const FlowDiagram = ({
  ...
  >
    ...
    <m.path
      ...
      animate={
        isHovered ? { strokeDashoffset: -1 } : { strokeDashoffset: 1.4 }
      }
...
const InvoiceCard = () => (
  <div className="bg-illustration corner-tr-bevel ring-border-illustration relative w-20 rounded-md rounded-tr-[15%] p-2.5 shadow-md ring-1 shadow-black/6.5">
...
const DatabaseTables = () => (
  <div className="ml-32 flex flex-col gap-48">
    <div className="ring-border-illustration w-32 overflow-hidden rounded-xl bg-card/75 shadow-md ring-1 shadow-black/6.5">
      <div className="flex items-center justify-center px-3 py-1.5">
        <span className="text-xs font-semibold">users</span>
      </div>
      <div className="bg-illustration space-y-1.5 border-t border-border/50 p-3">
