export const PaymentIllustration = () => (
  <div
    aria-hidden
    className="relative min-w-xs [--color-primary-foreground:var(--color-white)] [--color-primary:var(--color-indigo-500)]"
  >
    <div className="ring-border-illustration relative space-y-5 rounded-2xl bg-card p-8 ring-1 shadow-black/6.5">
      <div>
        <div className="mb-3 text-sm font-medium text-foreground">Email</div>
