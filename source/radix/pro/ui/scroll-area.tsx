    ...
    return (
        <ScrollAreaPrimitive.Root
            ...
            <ScrollAreaPrimitive.Viewport
                ...
                className="mask-y-from-95% focus-visible:ring-ring/50 size-full rounded-[inherit] outline-none transition-[color,box-shadow] focus-visible:outline-1 focus-visible:ring-[3px]">
                {children}
            </ScrollAreaPrimitive.Viewport>
            <ScrollBar />
