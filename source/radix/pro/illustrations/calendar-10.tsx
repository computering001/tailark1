...
export const Calendar10Illustration = () => {
    return (
        <div
            aria-hidden
            className="mask-radial-[100%_100%] mask-radial-from-75% mask-radial-at-top px-6 pt-1">
            <div className="ring-border-illustration bg-card shadow-black/6.5 min-w-md rounded-2xl shadow-xl ring-1">
...
export default Calendar10Illustration
