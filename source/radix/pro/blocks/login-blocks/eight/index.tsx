            ...
            <div className="relative flex min-h-dvh flex-col items-center justify-center p-6">
                <div className="mx-auto w-full max-w-sm">
                    <div className="mb-8 space-y-4 px-4">
                        ...
                        <h1 className="text-muted-foreground text-balance px-4 text-xl font-medium">
                            Welcome back to Tailark! <span className="text-foreground"> Log in to continue</span>
                        </h1>
                    </div>
