...
export default function HeaderOne() {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "absolute inset-x-0 top-0 z-50 h-15 border-transparent ring-1 ring-transparent transition-[height,background-color,border-color,box-shadow,backdrop-filter] duration-200 ease-[cubic-bezier(0.645,0.045,0.355,1)]",
          "in-data-scrolled:border-b in-data-scrolled:border-border in-data-scrolled:bg-background/75 in-data-scrolled:backdrop-blur",
          "has-data-[state=open]:border-transparent lg:has-data-[state=open]:h-[calc(var(--nav-viewport-height,0px)+3.4rem)] lg:has-data-[state=open]:border-b lg:has-data-[state=open]:bg-card/75 lg:has-data-[state=open]:shadow-lg lg:has-data-[state=open]:shadow-black/6.5 lg:has-data-[state=open]:ring-border lg:has-data-[state=open]:backdrop-blur",
        ...
        {mobileLinks.map((link) => {
          if (link.groupName && link.links) {
            return (
              ...
              >
                <AccordionTrigger className="flex items-center justify-between border-b-0 py-3 text-lg **:font-normal! data-[state=open]:bg-foreground/5">
                  {link.groupName}
                </AccordionTrigger>
      ...
      <NavigationMenuList className="gap-3">
        <NavigationMenuItem value="product">
          ...
          <NavigationMenuContent className="mt-4.5 origin-top pt-5 pb-14 shadow-none ring-0">
            <div className="mx-auto grid w-full max-w-5xl min-w-5xl grid-cols-4 gap-4 divide-x divide-foreground/10 pl-10">
