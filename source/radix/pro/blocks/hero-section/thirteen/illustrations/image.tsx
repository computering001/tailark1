                ...
                <div className="group relative">
                    <button type="button" className="absolute inset-1 z-10 flex items-center justify-center rounded-xl border border-dotted border-white/15">
                        <Button
                            ...
                            variant="outline"
                            asChild
                            className="active:scale-99 m-auto w-fit rounded-full bg-white/15 text-white shadow-lg ring-white/25 backdrop-blur transition-[transform,background-color,color,box-shadow] duration-200 before:absolute before:inset-0 hover:-translate-y-1 hover:scale-105 hover:bg-white/20 active:-translate-y-0.5">
                            <div>
