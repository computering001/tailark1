        ...
        <section className="bg-background border-b">
            <div className="mx-auto max-w-6xl border-x px-6 py-8 md:py-16">
                <div className="mx-auto mb-12 max-w-xl text-balance text-center md:mb-16">
                    <p className="text-muted-foreground mt-4 md:text-lg">Tailark is trusted by leading teams from Generative AI Companies, Hosting Providers, Payments Providers, Streaming Providers</p>
                </div>
