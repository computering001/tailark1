...
export default function StatsSection() {
    return (
        <section className="bg-background @container relative py-12 md:py-20">
            <div className="mask-radial-to-75% absolute inset-0 max-md:hidden">
                <Map />
            </div>
            <div className="mx-auto max-w-5xl px-6">
                <div className="md:max-w-3/5 lg:max-w-1/2 bg-card ring-border shadow-black/6.5 relative rounded-xl p-6 shadow-xl ring-1 sm:p-10">
                    <div className="mb-8 space-y-4">
                        <h2 className="text-muted-foreground text-balance text-3xl font-semibold tracking-tight">
