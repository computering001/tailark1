                ...
                <div className="grid gap-12 sm:grid-cols-2">
                    ...
                    <div className="space-y-6 border-l sm:mx-auto sm:max-w-xs">
                        <div className="space-y-4 *:block">
                            <span className="border-primary -ml-px border-l pl-6 text-3xl font-semibold lg:pl-8 tracking-tight">99.9%</span>
                        ...
                        <div className="space-y-4 *:block">
                            <span className="border-primary -ml-px border-l pl-6 text-3xl font-semibold lg:pl-8 tracking-tight">24/7</span>
                            <p className="text-muted-foreground text-balance pl-6 text-sm lg:pl-8">
