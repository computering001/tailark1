  ...
  return (
    <div aria-hidden className="relative w-full select-none">
      <div className="relative w-full space-y-2 py-4">
        <div className="absolute inset-y-0 left-0 w-px bg-[linear-gradient(180deg,var(--color-foreground)_1px,transparent_1px)] bg-size-[1px_4px] bg-repeat-y opacity-25" />
        ...
        <div className="relative -mx-5 flex rounded-xl bg-illustration p-2 text-xs shadow ring-1 shadow-black/10 ring-border-illustration">
