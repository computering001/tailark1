                    ...
                    <div className="@max-4xl:max-w-sm relative mx-auto border">
                        ...
                        <div className="relative mx-auto border-b">
                            ...
                            <div className="@4xl:grid-cols-3 grid *:p-8">
                                ...
                                <div className="rounded-(--radius) ring-border bg-card @4xl:my-2 @max-4xl:mx-1 shadow-black/6.5 row-span-4 grid grid-rows-subgrid gap-8 shadow-xl ring-1 backdrop-blur">
                                    <div className="self-end">
                        ...
                        <div className="relative mt-6">
                            ...
                            <div className="@4xl:grid-cols-3 @max-4xl:divide-y @4xl:divide-x grid border-t *:p-8">
                                <div className="space-y-6">
                                    <div className="self-end">
                                        <CardTitle className="text-lg font-medium">Enterprise Custom Plan</CardTitle>
                                        <div className="text-muted-foreground mt-1 text-balance text-sm">For large organizations with complex workflows and advanced reporting requirements. </div>
                                    </div>
                                    <Button
                                        asChild
                                        variant="outline"
                                ...
                                <div className="col-span-2">
                                    <ul
                                        ...
                                        {['1 Custom Report Per Month', 'Standard Security Features', 'Access to Advanced Templates', 'Access to Community Forum', 'Mobile App Access', 'Custom Invoicing', 'Custom User Roles', 'Enhanced Reporting', 'Priority Support'].map((item, index) => (
                                            <li
                                                key={item}
                                                className="flex items-center gap-2">
                                                <Check
