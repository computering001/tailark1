...
export default function CodeBlock() {
  ...
  return (
    ...
    <div className="relative z-10 max-w-[calc(100vw-3rem)] overflow-hidden rounded-2xl border border-transparent bg-illustration pt-6 shadow-lg ring-1 shadow-black/6.5 ring-border-illustration backdrop-blur">
