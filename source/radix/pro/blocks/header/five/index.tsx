  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            "fixed inset-x-0 top-0 z-50 pt-2 max-lg:h-18 max-lg:overflow-hidden max-lg:px-2 max-lg:in-data-[state=active]:h-screen max-lg:in-data-[state=active]:bg-card/75 max-lg:in-data-[state=active]:backdrop-blur lg:pt-3"
          )}
        >
          <div
            className={cn(
            ...
            <div className="relative flex flex-wrap items-center justify-between lg:py-3">
              <div className="flex items-center justify-between gap-8 max-lg:h-14 max-lg:w-full max-lg:in-data-[state=active]:border-b">
                <Link
                  href="/"
                  aria-label="home"
                  className="h-fit transition-[padding] duration-500 lg:in-data-scrolled:px-2"
                >
                  <Logo uniColor />
                </Link>
...
const NavMenu = () => {
  return (
    <NavigationMenu
      viewport={false}
      className="**:data-[slot=navigation-menu-content]:top-full **:data-[slot=navigation-menu-content]:mt-2 max-lg:hidden"
    >
