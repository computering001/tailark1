...
const NavMenu = () => {
  return (
    <NavigationMenu className="[--viewport-top:2.5rem] **:data-[slot=navigation-menu-viewport]:max-w-2xl **:data-[slot=navigation-menu-viewport]:min-w-lg **:data-[slot=navigation-menu-viewport]:translate-x-(--viewport-translate) **:data-[slot=navigation-menu-viewport]:transition-none max-lg:hidden">
