          ...
          if (link.groupName && link.links) {
            return (
              <AccordionItem
                ...
                className="group relative not-last:border-b-0 before:pointer-events-none before:absolute before:inset-x-0 before:bottom-0 before:border-b before:border-border"
              >
