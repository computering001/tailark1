...
const RAW_ARTICLES: Article[] = [
            {
                ...
                category: 'company',
                image: 'https://raw.githubusercontent.com/tailark/assets/refs/heads/main/blog-1_roo7z2.png',
                date: 'Aug 18, 2025',
                href: '#',
                authors: [
            ...
            },
            {
                ...
                category: 'marketing',
                image: 'https://raw.githubusercontent.com/tailark/assets/refs/heads/main/blog-2_cazz7h.png',
                date: 'Sep 10, 2025',
                href: '#',
                authors: [
            ...
            },
            {
                ...
                category: 'company',
                image: 'https://raw.githubusercontent.com/tailark/assets/refs/heads/main/blog-4_lojema.jpg',
                date: 'Oct 5, 2025',
                href: '#',
                authors: [
                    { name: 'Shadcn', image: SHADCN_AVATAR },
            ...
            },
            {
                ...
                category: 'company',
                image: 'https://raw.githubusercontent.com/tailark/assets/refs/heads/main/blog-5_gpo4j1.png',
                date: 'Oct 15, 2025',
                href: '#',
            ...
            },
            {
                ...
                category: 'marketing',
                image: 'https://raw.githubusercontent.com/tailark/assets/refs/heads/main/blog-7_rlrsyt.jpg',
                date: 'Nov 1, 2025',
                href: '#',
            ...
            },
            {
                ...
                category: 'newsroom',
                image: 'https://raw.githubusercontent.com/tailark/assets/refs/heads/main/blog-5_widlus.jpg',
                date: 'Dec 5, 2025',
                href: '#',
            ...
            },
            {
                ...
                category: 'newsroom',
                image: 'https://raw.githubusercontent.com/tailark/assets/refs/heads/main/blog-6_epbcd1.jpg',
                date: 'Dec 5, 2025',
                href: '#',
                    ...
                    <div className="lg:min-w-5xl mx-auto w-full p-[0.5px]">
                        <div className="bg-card h-full rounded-md">
                            <div className="max-w-lg px-6 pb-6 pt-12 md:pt-24">
                                ...
                                <h2 className="text-muted-foreground mt-4 text-balance text-4xl font-semibold tracking-tight">
                        ...
                        {topArticles.map((article, index) => (
                            <div
                                ...
                                <article className="group grid gap-px sm:grid-cols-2">
                                    <div className="bg-card/75 group-hover:bg-card rounded-md p-6">
                                    ...
                                    <div className="bg-card flex flex-col space-y-4 rounded-md p-6 md:py-12">
                                        <time
                                ...
                                <div className="relative">
                                    ...
                                    <div className="grid gap-px sm:grid-cols-2 lg:grid-cols-3">
                                        {moreArticles.map((article, index) => (
                                            <article
                                                key={article.title}
                                                className="bg-card hover:bg-card/75 group relative flex flex-col space-y-4 rounded-md p-6 transition-colors duration-200">
