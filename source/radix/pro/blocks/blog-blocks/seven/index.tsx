...
const RAW_ARTICLES: Article[] = [
  {
    ...
    category: "company",
    image:
      "https://raw.githubusercontent.com/tailark/assets/refs/heads/main/blog-1_roo7z2.png",
    date: "Aug 18, 2025",
    href: "#",
    authors: [
  ...
  },
  {
    ...
    category: "marketing",
    image:
      "https://raw.githubusercontent.com/tailark/assets/refs/heads/main/blog-2_cazz7h.png",
    date: "Sep 10, 2025",
    href: "#",
    authors: [
  ...
  },
  {
    ...
    category: "company",
    image:
      "https://raw.githubusercontent.com/tailark/assets/refs/heads/main/blog-4_lojema.jpg",
    date: "Oct 5, 2025",
    href: "#",
    authors: [
      { name: "Shadcn", image: SHADCN_AVATAR },
  ...
  },
  {
    ...
    category: "company",
    image:
      "https://raw.githubusercontent.com/tailark/assets/refs/heads/main/blog-5_gpo4j1.png",
    date: "Oct 15, 2025",
    href: "#",
  ...
  },
  {
    ...
    category: "marketing",
    image:
      "https://raw.githubusercontent.com/tailark/assets/refs/heads/main/blog-7_rlrsyt.jpg",
    date: "Nov 1, 2025",
    href: "#",
  ...
  },
  {
    ...
    category: "newsroom",
    image:
      "https://raw.githubusercontent.com/tailark/assets/refs/heads/main/blog-5_widlus.jpg",
    date: "Dec 5, 2025",
    href: "#",
  ...
  },
  {
    ...
    category: "newsroom",
    image:
      "https://raw.githubusercontent.com/tailark/assets/refs/heads/main/blog-6_epbcd1.jpg",
    date: "Dec 5, 2025",
    href: "#",
...
export default function Blog() {
  ...
  const rawArticles = RAW_ARTICLES
  ...
  return (
    <section className="bg-background">
      <div className="@container relative bg-foreground/9">
        <div className="relative z-1 grid-cols-[1fr_auto_1fr] lg:grid">
          ...
          <div className="mx-auto w-full p-[0.5px] lg:min-w-5xl">
            <div className="h-full rounded-md bg-card">
              <div className="max-w-lg px-6 pt-12 pb-6 md:pt-24">
                ...
                <h2 className="mt-4 text-4xl font-semibold text-balance text-muted-foreground tracking-tight">
                          ...
                          <span
                            className={cn(
                              ...
                              activeFilter === category
                                ? "bg-illustration font-medium text-primary shadow-sm ring-1 ring-border-illustration"
              ...
              <div className="relative lg:col-span-4">
                <div className="grid gap-px sm:grid-cols-2">
                  {articles.map((article, index) => (
                    <article
                      key={article.title}
                      className="group relative flex flex-col space-y-4 rounded-md bg-card p-6 transition-colors duration-200 hover:bg-card/75"
                    >
                      <div className="relative aspect-video overflow-hidden rounded-[10px] shadow-md shadow-black/10 before:absolute before:inset-0 before:rounded-[10px] before:border before:border-background/10 before:inset-ring-1 before:inset-ring-foreground/10">
                        <Image
                          src={article.image}
                          alt={article.title}
                          width={6394}
                      ...
                      <div className="mt-auto grid grid-cols-[1fr_auto] items-end gap-2 pt-4">
                        <div className="space-y-2">
                          {article.authors.map((author) => (
                            ...
                            >
                              <div className="aspect-square size-6 overflow-hidden rounded-md border border-transparent bg-card shadow-md ring-1 shadow-black/15 ring-border-illustration">
                                <Image
                                  src={author.image}
                                  alt={author.name}
                                  width={46}
                        ...
                        <div className="flex h-6 items-center">
                          <span
                            ...
                            className="flex items-center gap-1 text-sm font-medium text-primary transition-colors duration-200 group-hover:text-foreground"
                          >
                            Read
                            <ChevronRight
                              strokeWidth={2.5}
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 top-0 left-0 z-0 size-56 -translate-x-1/2 -translate-y-1/2 rounded-full bg-linear-to-r/increasing from-indigo-300 via-white to-emerald-300 opacity-25 blur-2xl"
