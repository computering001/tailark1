        ...
        <section className="bg-background py-16 md:py-32">
            <div className="@container mx-auto max-w-5xl">
                ...
                <div className="relative grid grid-cols-3 max-sm:-space-x-4 lg:gap-6">
                    <div className="bg-card ring-foreground/5 shadow-black/3 z-2 h-fit -rotate-12 p-4 shadow-xl ring-1">
                        ...
                        <p className="text-muted-foreground mt-3 text-xs">Strategy offsite - Austin 2024</p>
                    </div>
                    <div className="bg-card ring-foreground/5 shadow-black/3 z-1 h-fit rotate-6 p-4 shadow-xl ring-1">
                        <div className="before:border-foreground/10 before:z-1 relative aspect-square overflow-hidden before:absolute before:inset-0 before:border">
                            <div
                                aria-hidden
                    ...
                    <div className="bg-card ring-foreground/5 shadow-black/3 mt-6 h-fit -rotate-12 p-4 shadow-xl ring-1">
                        <div className="before:border-foreground/10 before:z-1 relative aspect-square overflow-hidden before:absolute before:inset-0 before:border">
                            <div
                                aria-hidden
